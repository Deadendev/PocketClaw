package com.inspiredandroid.pocketclaw.notifications
 ...
 * the feature is gated by the `PocketClawNotificationListenerService` being declared in the
 ...
 *
 * Unlike [com.inspiredandroid.pocketclaw.sms.SmsReader] which queries the system content
 * provider, this reads from the in-process [com.inspiredandroid.pocketclaw.data.NotificationStore]
