...
import pocketclaw.composeapp.generated.resources.tool_web_search_description
import pocketclaw.composeapp.generated.resources.tool_web_search_name
    ...
    override suspend fun execute(args: Map<String, Any>): Any {
        ...
        return try {
            ...
            val response = client.get("https://lite.duckduckgo.com/lite/?q=$encoded") {
                header("User-Agent", "Mozilla/5.0 (compatible; PocketClaw/1.0)")
            }
