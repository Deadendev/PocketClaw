...
import com.inspiredandroid.pocketclaw.ui.dynamicui.PocketClawUiNode
...
@Immutable
data class PocketClawUiBlock(val node: PocketClawUiNode, val rawJson: String) : BlockNode

@Immutable
data class PocketClawUiError(val rawJson: String) : BlockNode
