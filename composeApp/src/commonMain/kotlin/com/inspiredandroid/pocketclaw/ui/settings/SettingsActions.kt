...
data class SettingsActions(
    ...
    val onToggleGithub: (Boolean) -> Unit,
    val onAddGithubAccount: (String, String, String) -> Unit,
    val onRemoveGithubAccount: (String) -> Unit,
    val onChangeGithubPollInterval: (Int) -> Unit,
    val onRefreshGithubAccount: (String) -> Unit,
    ...
    companion object {
        val NoOp = SettingsActions(
            ...
            onToggleGithub = {},
            onAddGithubAccount = { _, _, _ -> },
            onRemoveGithubAccount = {},
            onChangeGithubPollInterval = {},
            onRefreshGithubAccount = {},
            onToggleSms = {},
