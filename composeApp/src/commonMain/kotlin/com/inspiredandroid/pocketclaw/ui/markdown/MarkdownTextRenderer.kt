...
import com.inspiredandroid.pocketclaw.ui.dynamicui.collectSpeakableText

/**
 * TTS-friendly text extracted from a parsed [MarkdownDocument]. Strips markdown formatting,
 * drops code blocks, reads link text (not URLs), and walks pocketclaw-ui blocks for their human-
 * readable labels.
 */
...
private fun blockToSpeakable(block: BlockNode): String = when (block) {
    ...
    is PocketClawUiBlock -> block.node.collectSpeakableText()
    is PocketClawUiError -> ""
}
