...
import com.inspiredandroid.pocketclaw.sandbox.LinuxSandboxManager
import com.inspiredandroid.pocketclaw.sandbox.SandboxState
import com.inspiredandroid.pocketclaw.sandbox.SessionShell
import com.inspiredandroid.pocketclaw.sandbox.openFileWithIntent
import com.inspiredandroid.pocketclaw.sandbox.resolveSandboxAbsolute
...
class AndroidSandboxController : SandboxController {
    ...
    override fun transcriptFor(sessionId: String): SnapshotStateList<com.inspiredandroid.pocketclaw.TerminalLine> = sandboxManager.transcriptFor(sessionId)
