...
import com.inspiredandroid.pocketclaw.notifications.declaresNotificationListener
import com.inspiredandroid.pocketclaw.sms.SmsReader
import com.inspiredandroid.pocketclaw.sms.SmsSender
import com.inspiredandroid.pocketclaw.sms.declaresReadSms
import com.inspiredandroid.pocketclaw.tools.CalendarPermissionController
import com.inspiredandroid.pocketclaw.tools.CalendarRepository
...
import com.inspiredandroid.pocketclaw.tools.NotificationResult
import com.inspiredandroid.pocketclaw.tools.NotificationTools
import com.inspiredandroid.pocketclaw.tools.OpenFileTool
import com.inspiredandroid.pocketclaw.tools.ProcessManagerTool
import com.inspiredandroid.pocketclaw.tools.SchedulingTools
import com.inspiredandroid.pocketclaw.tools.ShellCommandTool
import com.inspiredandroid.pocketclaw.tools.SmsTools
import com.inspiredandroid.pocketclaw.tools.SshConfigureHostTool
import com.inspiredandroid.pocketclaw.tools.WebSearchTool
...
import pocketclaw.composeapp.generated.resources.tool_create_calendar_event_description
import pocketclaw.composeapp.generated.resources.tool_create_calendar_event_name
import pocketclaw.composeapp.generated.resources.tool_open_file_description
import pocketclaw.composeapp.generated.resources.tool_open_file_name
import pocketclaw.composeapp.generated.resources.tool_send_notification_description
import pocketclaw.composeapp.generated.resources.tool_send_notification_name
import pocketclaw.composeapp.generated.resources.tool_set_alarm_description
import pocketclaw.composeapp.generated.resources.tool_set_alarm_name
...
actual fun createSecureSettings(): Settings {
    ...
    return try {
        ...
        context.deleteSharedPreferences("pocketclaw_secure_prefs")
        SharedPreferencesSettings(createEncryptedPrefs(context))
    }
}
...
actual fun createLegacySettings(): Settings? {
    val context: Context by inject(Context::class.java)
    val prefs = context.getSharedPreferences("com.inspiredandroid.pocketclaw_preferences", Context.MODE_PRIVATE)
            ...
            add(
                object : Tool {
                    ...
                    override suspend fun execute(args: Map<String, Any>): Any {
                        val title = args["title"] as? String ?: "PocketClaw"
