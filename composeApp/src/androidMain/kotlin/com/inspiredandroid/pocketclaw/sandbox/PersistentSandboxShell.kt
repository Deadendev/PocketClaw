package com.inspiredandroid.pocketclaw.sandbox

import com.inspiredandroid.pocketclaw.smartTruncate
...
class PersistentSandboxShell(
    ...
    suspend fun run(
        ...
        val cmdFile = File(tmpPath, ".pocketclaw_cmd_$nonce")
        try {
        ...
        val line = ". /tmp/.pocketclaw_cmd_$nonce; __pocketclaw_st=\$?; rm -f /tmp/.pocketclaw_cmd_$nonce; " +
            "printf '\\n\\036%s\\037%d\\037%d\\037%s\\036\\n' '$nonce' \"\$__pocketclaw_st\" \"\$\$\" \"\$PWD\" >&2"
