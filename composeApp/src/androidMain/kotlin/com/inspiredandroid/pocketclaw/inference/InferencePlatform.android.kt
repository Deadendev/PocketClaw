package com.inspiredandroid.pocketclaw.inference
...
actual fun updateDownloadNotificationProgress(percent: Int) {
    try {
        ...
        val builder = android.app.Notification.Builder(context, "pocketclaw_model_download_channel")
        val notification = builder
            .setContentTitle(context.getString(com.inspiredandroid.pocketclaw.shared.R.string.app_name))
